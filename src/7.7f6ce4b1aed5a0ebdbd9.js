(window.webpackJsonp = window.webpackJsonp || []).push([
    [7], {
            ...
            var r = n("Ip0R"),
                ...
                l = function() {
                    function t(t, e, n, r, i) {
                        this.elementRef = t, this.doc = e, this.platformId = n, this.renderer = r, this.zone = i, this.emptyArray = [], this.defaultModules = {
                            toolbar: [
                        ...
                        }, this.style = {}, this.strict = !0, this.customOptions = [], this.onEditorCreated = new o.EventEmitter, this.onContentChanged = new o.EventEmitter, this.onSelectionChanged = new o.EventEmitter, this.valueGetter = function(t, e) {
                            var n = e.children[0].innerHTML;
                            return "<p><br></p>" !== n && "<div><br><div>" !== n || (n = null), n
                        }, this.valueSetter = function(t, e) {
                            return t.clipboard.convert(e)
                        }, this.onModelChange = function() {}, this.onModelTouched = function() {}
                    }
                    return t.prototype.ngAfterViewInit = function() {
                        var t = this;
                        if (!Object(r.isPlatformServer)(this.platformId)) {
                            i || (i = n("kzlf"));
                            var e = this.elementRef.nativeElement.querySelector("[quill-editor-toolbar]"),
                                o = this.modules || this.defaultModules,
                                l = "Insert text here ...";
                            if (null !== this.placeholder && void 0 !== this.placeholder && (l = this.placeholder.trim()), e && (o.toolbar = e), this.elementRef.nativeElement.insertAdjacentHTML("beforeend", "<div quill-editor-element></div>"), this.editorElem = this.elementRef.nativeElement.querySelector("[quill-editor-element]"), this.style && Object.keys(this.style).forEach(function(e) {
                                    t.renderer.setStyle(t.editorElem, e, t.style[e])
                                }), this.customOptions.forEach(function(t) {
                                    var e = i.import(t.import);
                                    e.whitelist = t.whitelist, i.register(e, !0)
                                }), this.quillEditor = new i(this.editorElem, {
                                    modules: o,
                                    placeholder: l,
                                    readOnly: this.readOnly || !1,
                                    theme: this.theme || "snow",
                                    formats: this.formats,
                                    bounds: this.bounds ? "self" === this.bounds ? this.editorElem : this.bounds : this.doc.body,
                                    strict: this.strict,
                                    scrollingContainer: this.scrollingContainer
                                }), this.content) {
                                var a = this.quillEditor.clipboard.convert(this.content);
                                this.quillEditor.setContents(a), this.quillEditor.history.clear()
                            }
                            this.onEditorCreated.emit(this.quillEditor), this.quillEditor.on("selection-change", function(e, n, r) {
                                t.zone.run(function() {
                                    t.onSelectionChanged.emit({
                                        editor: t.quillEditor,
                                        range: e,
                                        oldRange: n,
                                        source: r
                                    }), e || t.onModelTouched()
                                })
                            }), this.quillEditor.on("text-change", function(e, n, r) {
                                var o = t.quillEditor.getText(),
                                    i = t.editorElem.children[0].innerHTML;
                                "<p><br></p>" !== i && "<div><br><div>" !== i || (i = null), t.zone.run(function() {
                                    t.onModelChange(t.valueGetter(t.quillEditor, t.editorElem)), t.onContentChanged.emit({
                                        editor: t.quillEditor,
                                        html: i,
                                        text: o,
                                        delta: e,
                        ...
                        this.quillEditor && (t.readOnly && this.quillEditor.enable(!t.readOnly.currentValue), t.placeholder && (this.quillEditor.root.dataset.placeholder = t.placeholder.currentValue))
                    }, t.prototype.writeValue = function(t) {
                        if (this.content = t, this.quillEditor) {
                            if (t) return void this.quillEditor.setContents(this.valueSetter(this.quillEditor, this.content));
                        ...
                        var t = {},
                            e = !0,
                            n = this.quillEditor.getText().trim().length;
                        return this.minLength && n && n < this.minLength && (t.minLengthError = {
                            given: n,
                            minLength: this.minLength
                        }, e = !1), this.maxLength && n > this.maxLength && (t.maxLengthError = {
                            given: n,
                            maxLength: this.maxLength
                        }, e = !1), this.required && !n && (t.requiredError = {
                            empty: !0
                        }, e = !1), e ? null : t
                    }, t
                }()
        ...
        g99b: function(t, e, n) {
            ...
            function i(t) {
                return r["\u0275vid"](0, [r["\u0275ncd"](null, 0)], null, null)
            }
        },
        kzlf: function(t, e, n) {
            var r;
            "undefined" != typeof self && self, r = function() {
                return function(t) {
                    ...
                    function f(t, e) {
                        var n;
                        if (void 0 === e && (e = c.ANY), "string" == typeof t) n = u[t] || l[t];
                        else if (t instanceof Text || t.nodeType === Node.TEXT_NODE) n = u.text;
                        else if ("number" == typeof t) t & c.LEVEL & c.BLOCK ? n = u.block : t & c.LEVEL & c.INLINE && (n = u.inline);
                        ...
                        return null == n ? null : e & c.LEVEL & n.scope && e & c.TYPE & n.scope ? n : null
                    }
                    e.create = function(t, e) {
                        ...
                        return u[r.blotName || r.attrName] = r, "string" == typeof r.keyName ? l[r.keyName] = r : (null != r.className && (a[r.className] = r), null != r.tagName && (r.tagName = Array.isArray(r.tagName) ? r.tagName.map(function(t) {
                            return t.toUpperCase()
                        }) : r.tagName.toUpperCase(), (Array.isArray(r.tagName) ? r.tagName : [r.tagName]).forEach(function(t) {
                    ...
                    s.prototype.insert = function(t, e) {
                        ...
                        if (t = i(!0, {}, t), "object" == typeof n) {
                            ...
                            if ("number" == typeof n.delete && null != t.insert && "object" != typeof(n = this.ops[(e -= 1) - 1])) return this.ops.unshift(t), this;
                    ...
                    var y = function(t) {
                        ...
                        return p(e, a.default.Embed), r(e, [{
                            key: "attach",
                            value: function() {
                    ...
                    var v = function(t) {
                        ...
                        return p(e, a.default.Block), r(e, [{
                            key: "delta",
                            value: function() {
                        ...
                        m = function() {
                            function t(e) {
                                ...
                                if (function(e, n) {
                                    ...
                                    }(this), this.options = _(e, r), this.container = this.options.container, null == this.container) return g.error("Invalid Quill container", e);
                            ...
                            return i(t, null, [{
                                ...
                                value: function(t, e) {
                                    ...
                                    }, arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : s.default.sources.API)
                                }
                            }, {
                                key: "formatLine",
                                value: function(t, e, n, r, i) {
                                    var l, a = this,
                                        s = w(t, e, n, r, i),
                                        u = o(s, 4);
                                    return e = u[1], l = u[2], O.call(this, function() {
                                ...
                                value: function(t, e, n, r, i) {
                                    var l, a = this,
                                        s = w(t, 0, n, r, i),
                                        u = o(s, 4);
                                    return l = u[2], O.call(this, function() {
                                ...
                                value: function(t, e, n) {
                                    var r = this,
                                        i = w(t, e, n),
                                        l = o(i, 4);
                                    return e = l[1], O.call(this, function() {
                                ...
                                value: function(t) {
                                    ...
                                    }, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : s.default.sources.API)
                                }
                            }, {
                                key: "setSelection",
                                value: function(e, n, r) {
                    ...
                    var r = function t(e) {
                        ...
                        ! function(e, n) {
                            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                        }(this), this.quill = e, this.options = n
                    };
                    ...
                    e.default = function() {
                        function t(e) {
                            ! function(e, n) {
                                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                            }(this), this.scroll = e, this.delta = this.getDelta()
                        }
                        return i(t, [{
                            key: "applyDelta",
                            value: function(t) {
                            ...
                            value: function(t, e) {
                                ...
                                }), this.scroll.optimize(), this.update((new l.default).retain(t).retain(e, (0, p.default)(r)))
                            }
                        }, {
                            key: "formatText",
                            value: function(t, e) {
                                ...
                                }), this.update((new l.default).retain(t).retain(e, (0, p.default)(r)))
                            }
                        }, {
                            key: "getContents",
                            value: function(t, e) {
                            ...
                            value: function(t, e) {
                                ...
                                }), this.update((new l.default).retain(t).insert(e, (0, p.default)(r)))
                            }
                        }, {
                            key: "isBlank",
                            value: function() {
                            ...
                            value: function(t, e) {
                                ...
                                var h = this.getContents(t, e + c).diff((new l.default).insert(n).concat(f)),
                                    d = (new l.default).retain(t).concat(h);
                            ...
                            value: function(t) {
                                ...
                                if (1 === e.length && "characterData" === e[0].type && e[0].target.data.match(g) && s.default.find(e[0].target)) {
                                    var o = s.default.find(e[0].target),
                                        ...
                                        d = (new l.default).insert(o.value());
                                    t = (new l.default).retain(a).concat(h.diff(d, n)).reduce(function(t, e) {
                            ...
                            return o(t, [{
                                ...
                                value: function(t) {
                                    ...
                                    if (e > 0) {
                                        ...
                                        var h = this.scroll.leaf(t + e),
                                            d = r(h, 2);
                                        if (s = d[1], null == (a = d[0])) return null;
                                ...
                                value: function() {
                                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : s.default.sources.USER,
                                        ...
                                        o = r(n, 2),
                                        i = o[1];
                                    if (this.lastRange = o[0], null != this.lastRange && (this.savedRange = this.lastRange), !(0, a.default)(e, this.lastRange)) {
                                        var u;
                                        !this.composing && null != i && i.native.collapsed && i.start.node !== this.cursor.textNode && this.cursor.restore();
                                        var c, f = [s.default.events.SELECTION_CHANGE, (0, l.default)(this.lastRange), (0, l.default)(e), t];
                                        (u = this.emitter).emit.apply(u, [s.default.events.EDITOR_CHANGE].concat(f)), t !== s.default.sources.SILENT && (c = this.emitter).emit.apply(c, f)
                                    }
                                }
                            }]), t
                        }();
                            ...
                            return void 0 === a && (a = !0), void 0 === s && (s = 1 / 0),
                                function i(s, p) {
                                    ...
                                    if (t(s, e)) y = new e;
                                        ...
                                        if (d && Buffer.isBuffer(s)) return y = new Buffer(s.length), s.copy(y), y;
                                    ...
                                    for (var g in t(s, e) && s.forEach(function(t, e) {
                                        ...
                                        var m;
                                        v && (m = Object.getOwnPropertyDescriptor(v, g)), m && null == m.set || (y[g] = i(s[g], p - 1))
                                    }
                                    if (Object.getOwnPropertySymbols) {
                                        var _ = Object.getOwnPropertySymbols(s);
                                        for (g = 0; g < _.length; g++) {
                                            var O = _[g];
                                            (!(x = Object.getOwnPropertyDescriptor(s, O)) || x.enumerable || c) && (y[O] = i(s[O], p - 1), x.enumerable || Object.defineProperty(y, O, {
                                                enumerable: !1
                                            }))
                                        }
                                    }
                                    if (c) {
                                        ...
                                        for (g = 0; g < w.length; g++) {
                                            var x, E = w[g];
                                            (x = Object.getOwnPropertyDescriptor(s, E)) && x.enumerable || (y[E] = i(s[E], p - 1), Object.defineProperty(y, E, {
                                                enumerable: !1
                                            }))
                                        }
                                    }
                        ...
                        return function(t, e) {
                            ...
                            value: function(t, n) {
                                var o = this.line(t),
                                    ...
                                    h = this.line(t + n),
                                    d = r(h, 1)[0];
                                if (i(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "deleteAt", this).call(this, t, n), null != d && a !== d && u > 0) {
                                    if (a instanceof s.BlockEmbed || d instanceof s.BlockEmbed) return void this.optimize();
                                    if (a instanceof f.default) {
                                        var p = a.newlineIndex(a.length(), !0);
                                        if (p > -1 && (a = a.split(p + 1)) === d) return void this.optimize()
                                    } else if (d instanceof f.default) {
                                        var y = d.newlineIndex(0);
                                        y > -1 && d.split(y + 1)
                                    }
                                    a.moveChildren(d, d.children.head instanceof c.default ? null : d.children.head), a.remove()
                                }
                                this.optimize()
                            }
                        }, {
                            ...
                            value: function() {
                                return function t(e, n, r) {
                                    ...
                                    return e.children.forEachAt(n, r, function(e, n, r) {
                                        p(e) ? o.push(e) : e instanceof l.default.Container && (o = o.concat(t(e, n, i))), i -= r
                                    }), o
                    ...
                    var r, o = function() {
                        ...
                        l = function(t) {
                            ...
                            }(e, i.default.Attributor.Style), o(e, [{
                                key: "value",
                                value: function(t) {
                    ...
                    a.blotName = "link", a.tagName = "A", a.SANITIZED_URL = "about:blank", a.PROTOCOL_WHITELIST = ["http", "https", "mailto", "tel"], e.default = a, e.sanitize = s
                }, function(t, e, n) {
                    "use strict";
                    Object.defineProperty(e, "__esModule", {
                        value: !0
                    ...
                    e.default = function() {
                        function t(e) {
                            ...
                            ! function(e, n) {
                                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                            }(this), this.select = e, this.container = document.createElement("span"), this.buildPicker(), this.select.style.display = "none", this.select.parentNode.insertBefore(this.container, this.select), this.label.addEventListener("mousedown", function() {
                                n.togglePicker()
                    ...
                    }), r.default.register(l.default, a.default, u.default, f.default, h.default, d.default), e.default = o.default
                }, function(t, e, n) {
                    "use strict";
                    Object.defineProperty(e, "__esModule", {
                        value: !0
                    ...
                    e.default = function(t) {
                        ...
                        return o(e, t), e.keys = function(t) {
                            ...
                            l(t, this.keyName).forEach(function(e) {
                                t.classList.remove(e)
                            }), 0 === t.classList.length && t.removeAttribute("class")
                        }, e.prototype.value = function(t) {
                            var e = (l(t, this.keyName)[0] || "").slice(this.keyName.length + 1);
                    ...
                    e.default = function(t) {
                        ...
                        return o(e, t), e.keys = function(t) {
                            ...
                            t.style[l(this.keyName)] = "", t.getAttribute("style") || t.removeAttribute("style")
                        }, e.prototype.value = function(t) {
                    ...
                    var r = function() {
                        ...
                        o = function() {
                            function t(e, n) {
                                ! function(e, n) {
                                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                                }(this), this.quill = e, this.options = n, this.modules = {}
                            }
                            return r(t, [{
                                key: "init",
                                value: function() {
                    ...
                    String.prototype.startsWith || (String.prototype.startsWith = function(t, e) {
                        ...
                        value: function(t) {
                            ...
                            for (var e, n = Object(this), r = n.length >>> 0, o = arguments[1], i = 0; i < r; i++)
                                if (t.call(o, e = n[i], i, n)) return e
                        }
                    ...
                    function i(t, e, u) {
                        ...
                        var d = t.substring(t.length - f),
                            p = function(t, e) {
                                ...
                                var d = function(t, e) {
                                    ...
                                    function o(t, e, n) {
                                        for (var r, o, i, l, u = t.substring(n, n + Math.floor(t.length / 4)), c = -1, f = ""; - 1 != (c = e.indexOf(u, c + 1));) {
                                            ...
                                            f.length < d + h && (f = e.substring(c - d, c) + e.substring(c, c + h), r = t.substring(0, n - d), o = t.substring(n + h), i = e.substring(0, c - d), l = e.substring(c + h))
                                        }
                                        return 2 * f.length >= t.length ? [r, o, i, l, f] : null
                                    }
                                    var i, l, u, c, f, h = o(n, r, Math.ceil(n.length / 4)),
                                        d = o(n, r, Math.ceil(n.length / 2));
                                    return h || d ? (i = d ? h && h[4].length > d[4].length ? h : d : h, t.length > e.length ? (l = i[0], u = i[1], c = i[2], f = i[3]) : (c = i[0], f = i[1], l = i[2], u = i[3]), [l, u, c, f, i[4]]) : null
                                }(t, e);
                                if (d) {
                                    var p = d[1],
                                        y = d[3],
                                ...
                                return function(t, e) {
                                    ...
                                    c[s + 1] = 0, f[s + 1] = 0;
                                    for (var d = o - i, p = d % 2 != 0, y = 0, v = 0, b = 0, g = 0, m = 0; m < a; m++) {
                                        for (var _ = -m + y; _ <= m - v; _ += 2) {
                                            for (var O = s + _, w = (A = _ == -m || _ != m && c[O - 1] < c[O + 1] ? c[O + 1] : c[O - 1] + 1) - _; A < o && w < i && t.charAt(A) == e.charAt(w);) A++, w++;
                                            if (c[O] = A, A > o) v += 2;
                                            else if (w > i) y += 2;
                                            else if (p && (k = s + d - _) >= 0 && k < u && -1 != f[k]) {
                                                var x = o - f[k];
                                                if (A >= x) return l(t, e, A, w)
                                            }
                                        }
                                        for (var E = -m + b; E <= m - g; E += 2) {
                                            for (var k = s + E, N = (x = E == -m || E != m && f[k - 1] < f[k + 1] ? f[k + 1] : f[k - 1] + 1) - E; x < o && N < i && t.charAt(o - x - 1) == e.charAt(i - N - 1);) x++, N++;
                                            if (f[k] = x, x > o) g += 2;
                                            else if (N > i) b += 2;
                                            else if (!p && (O = s + d - E) >= 0 && O < u && -1 != c[O]) {
                                                var A = c[O];
                                                if (w = s + A - O, A >= (x = o - x)) return l(t, e, A, w)
                                            }
                                        }
                                    }
                                    return [
                        ...
                        return h && p.unshift([o, h]), d && p.push([o, d]),
                            function t(e) {
                                e.push([o, ""]);
                                for (var i, l = 0, u = 0, c = 0, f = "", h = ""; l < e.length;) switch (e[l][0]) {
                                    case r:
                                        c++, h += e[l][1], l++;
                                        break;
                                    case n:
                                        ...
                                        break;
                                    case o:
                                        u + c > 1 ? (0 !== u && 0 !== c && (0 !== (i = a(h, f)) && (l - u - c > 0 && e[l - u - c - 1][0] == o ? e[l - u - c - 1][1] += h.substring(0, i) : (e.splice(0, 0, [o, h.substring(0, i)]), l++), h = h.substring(i), f = f.substring(i)), 0 !== (i = s(h, f)) && (e[l][1] = h.substring(h.length - i) + e[l][1], h = h.substring(0, h.length - i), f = f.substring(0, f.length - i))), 0 === u ? e.splice(l - c, u + c, [r, h]) : 0 === c ? e.splice(l - u, u + c, [n, f]) : e.splice(l - u - c, u + c, [n, f], [r, h]), l = l - u - c + (u ? 1 : 0) + (c ? 1 : 0) + 1) : 0 !== l && e[l - 1][0] == o ? (e[l - 1][1] += e[l][1], e.splice(l, 1)) : l++, c = 0, u = 0, f = "", h = ""
                                }
                                "" === e[e.length - 1][1] && e.pop();
                                var d = !1;
                                for (l = 1; l < e.length - 1;) e[l - 1][0] == o && e[l + 1][0] == o && (e[l][1].substring(e[l][1].length - e[l - 1][1].length) == e[l - 1][1] ? (e[l][1] = e[l - 1][1] + e[l][1].substring(0, e[l][1].length - e[l - 1][1].length), e[l + 1][1] = e[l - 1][1] + e[l + 1][1], e.splice(l - 1, 1), d = !0) : e[l][1].substring(0, e[l + 1][1].length) == e[l + 1][1] && (e[l - 1][1] += e[l + 1][1], e[l][1] = e[l][1].substring(e[l + 1][1].length) + e[l + 1][1], e.splice(l + 1, 1), d = !0)), l++;
                                d && t(e)
                    ...
                    var O = (0, c.default)("quill:clipboard"),
                        ...
                        x = [
                            ...
                            [Node.ELEMENT_NODE, function(t, e) {
                                var n = {},
                                    r = t.style || {};
                                return r.fontStyle && "italic" === j(t).fontStyle && (n.italic = !0), r.fontWeight && (j(t).fontWeight.startsWith("bold") || parseInt(j(t).fontWeight) >= 700) && (n.bold = !0), Object.keys(n).length > 0 && (e = A(e, n)), parseFloat(r.textIndent || 0) > 0 && (e = (new a.default).insert("\t").concat(e)), e
                            }],
                            ["li", function(t, e) {
                            ...
                            return function(t, e) {
                                ...
                                value: function(t) {
                                    ...
                                    if (e[p.default.blotName]) {
                                        ...
                                        return this.container.innerHTML = "", (new a.default).insert(n, _({}, p.default.blotName, e[p.default.blotName]))
                                    }
                    ...
                    N.DEFAULTS = {
                        matchers: [],
                        matchVisual: !0
                    }, e.default = N, e.matchAttributor = P, e.matchBlot = C, e.matchNewline = L, e.matchSpacing = M, e.matchText = R
                }, function(t, e, n) {
                    "use strict";
                    Object.defineProperty(e, "__esModule", {
                        value: !0
                    ...
                    a.blotName = "bold", a.tagName = ["STRONG", "B"], e.default = a
                }, function(t, e, n) {
                    "use strict";
                    Object.defineProperty(e, "__esModule", {
                        value: !0
                    ...
                    e.default = function() {
                        function t(e, n) {
                            ...
                            ! function(e, n) {
                                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                            }(this), this.quill = e, this.boundsContainer = n || document.body, this.root = e.addContainer("ql-tooltip"), this.root.innerHTML = this.constructor.TEMPLATE, this.quill.root === this.quill.scrollingContainer && this.quill.root.addEventListener("scroll", function() {
                    ...
                    var v = [
                        ...
                        b = function(t) {
                            function e(t, n) {
                                d(this, e), null != n.modules.toolbar && null == n.modules.toolbar.container && (n.modules.toolbar.container = v);
                                var r = p(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                                return r.quill.container.classList.add("ql-snow"), r
                            }
                            return y(e, s.default), o(e, [{
                                key: "extendToolbar",
                                value: function(t) {
                                    ...
                                    if (null != e) {
                                        if (0 === e.length && r === l.default.sources.USER) {
                                            var o = function(t, e) {
                                                ...
                                                i = o[0];
                                            if (null != i) {
                                                t.linkRange = new c.Range(e.index - o[1], i.length());
                                                var a = u.default.formats(i.domNode);
                    ...
                    g.TEMPLATE = ['<a class="ql-preview" target="_blank" href="about:blank"></a>', '<input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join(""), e.default = b
                }, function(t, e, n) {
                    "use strict";
                    Object.defineProperty(e, "__esModule", {
                        value: !0
                    ...
                    i.blotName = "blockquote", i.tagName = "blockquote", e.default = i
                }, function(t, e, n) {
                    "use strict";
                    Object.defineProperty(e, "__esModule", {
                        value: !0
                    ...
                    i.blotName = "italic", i.tagName = ["EM", "I"], e.default = i
                }, function(t, e, n) {
                    "use strict";
                    Object.defineProperty(e, "__esModule", {
                        value: !0
